...
function Messaging() {
  ...
  return (
    <div className=" bg-linear-gradient flex items-center justify-center p-2" style={{ height: '680px' }}>
      <div className="bg-surface border border-border rounded-2xl shadow-xl h-full w-full max-w-7xl px-1 py-4 flex">
        {/* Sidebar for Conversation List */}
        <div className="bg-surface border-r border-border h-full w-2/5 pr-1">
